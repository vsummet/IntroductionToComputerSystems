...
5. git Exercise
   ...
   0. Begin by navigating to your ```cms230``` directory on codeanywhere.  Make a new directory named ```lab0``` and move (```cd```) into it.
